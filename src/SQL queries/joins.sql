...
--
-- Список модулей у TO
--SELECT TARGET_OBJECT.NAME, TARGET_OBJECT_SUBTYPE.LABEL_KEY, MODULE_SUBTYPE.MODULE_ID, MODULE.LABEL_KEY FROM TARGET_OBJECT
--JOIN HAS_SUBTYPE
--ON TARGET_OBJECT.ID = HAS_SUBTYPE.TARGET_OBJECT_ID
--JOIN TARGET_OBJECT_SUBTYPE
--ON HAS_SUBTYPE.TARGET_OBJECT_SUBTYPE_ID = TARGET_OBJECT_SUBTYPE.ID
...
--JOIN MODULE
--ON MODULE_SUBTYPE.MODULE_ID = MODULE.ID
--WHERE TARGET_OBJECT.NAME LIKE '% room' AND TARGET_OBJECT_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41 AND MODULE_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41 AND MODULE.SAFETY_CONCEPT_VERSION_ID=41;
--
--
-- Список сейфгарлов у конкретного ТО
--SELECT TARGET_OBJECT.NAME, TARGET_OBJECT_SUBTYPE.LABEL_KEY AS SUBTYPE, MODULE.LABEL_KEY AS MODULE, SAFE_GUARD.LABEL_KEY as SAFEGUARD
--FROM TARGET_OBJECT
--JOIN HAS_SUBTYPE
--ON TARGET_OBJECT.ID = HAS_SUBTYPE.TARGET_OBJECT_ID
--JOIN TARGET_OBJECT_SUBTYPE
...
--JOIN MODULE
--ON MODULE_SUBTYPE.MODULE_ID = MODULE.ID
--JOIN MODULE_CONTAINS_SAFE_GUARD
--ON MODULE.ID = MODULE_CONTAINS_SAFE_GUARD.MODULE_ID
--JOIN SAFE_GUARD
--on MODULE_CONTAINS_SAFE_GUARD.SAFE_GUARD_ID = SAFE_GUARD.ID
--WHERE TARGET_OBJECT.NAME LIKE '% room'
--AND TARGET_OBJECT_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41
--AND MODULE_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41
--AND MODULE.SAFETY_CONCEPT_VERSION_ID=41
--AND MODULE_CONTAINS_SAFE_GUARD.SAFETY_CONCEPT_VERSION_ID=41
--AND SAFE_GUARD.SAFETY_CONCEPT_VERSION_ID = 41;

-- Список сейфгардов у всех ТО
--SELECT TARGET_OBJECT.NAME, TARGET_OBJECT_SUBTYPE.LABEL_KEY AS SUBTYPE, MODULE.LABEL_KEY AS MODULE, SAFE_GUARD.LABEL_KEY as SAFEGUARD
--FROM TARGET_OBJECT
--JOIN HAS_SUBTYPE
--ON TARGET_OBJECT.ID = HAS_SUBTYPE.TARGET_OBJECT_ID
...
--JOIN SAFE_GUARD
--on MODULE_CONTAINS_SAFE_GUARD.SAFE_GUARD_ID = SAFE_GUARD.ID
--WHERE TARGET_OBJECT_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41
--AND MODULE_SUBTYPE.SAFETY_CONCEPT_VERSION_ID = 41
--AND MODULE.SAFETY_CONCEPT_VERSION_ID=41
--AND MODULE_CONTAINS_SAFE_GUARD.SAFETY_CONCEPT_VERSION_ID=41
--AND SAFE_GUARD.SAFETY_CONCEPT_VERSION_ID = 41
--ORDER BY TARGET_OBJECT.NAME;

-- Количество сейфгардов у конкретного ТО
--SELECT TARGET_OBJECT.NAME, COUNT(SAFE_GUARD.LABEL_KEY) as SAFEGUARD
--FROM TARGET_OBJECT
--JOIN HAS_SUBTYPE
--ON TARGET_OBJECT.ID = HAS_SUBTYPE.TARGET_OBJECT_ID
--JOIN TARGET_OBJECT_SUBTYPE
