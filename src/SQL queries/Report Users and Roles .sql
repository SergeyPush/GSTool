...
--Report header
--SELECT CONFIGURATION_OPTION.CATEGORY, CONFIGURATION_OPTION_VALUE.VALUE
--FROM CONFIGURATION_OPTION
--JOIN CONFIGURATION_OPTION_VALUE
--ON CONFIGURATION_OPTION.ID = CONFIGURATION_OPTION_VALUE.CONFIGURATION_OPTION_ID
--where CONFIGURATION_OPTION.CATEGORY = 'reportHeader';

-- Without null
--SELECT ACCESS_USER.ACCOUNTNAME AS "Username",
--ACCESS_USER.ACTIVE AS "Activated",
--NVL(TO_CHAR(ACCESS_USER.VALID), ' ' ) as "Valid until",
--ACCESS_USER.CHANGE_PASSWORD AS "Password must be changed",
--ACCESS_USER.PHONE AS "Phone",
--ACCESS_USER.FUNCTION AS "Function",
--ACCESS_USER.LASTNAME AS "Lastname",
...
ACCESS_ROLE.NAME AS "Name",
ACCESS_ROLE.DESCRIPTION AS "Description",
(SELECT CONFIGURATION_OPTION_VALUE.VALUE
FROM CONFIGURATION_OPTION
JOIN CONFIGURATION_OPTION_VALUE
ON CONFIGURATION_OPTION.ID = CONFIGURATION_OPTION_VALUE.CONFIGURATION_OPTION_ID
where CONFIGURATION_OPTION.CATEGORY = 'reportHeader') as "Header"
